	...
	<div class=" mb-5 bg-gray-900">
		...
		<div class="flex">	
			<div class="m-auto">
				...
				<a class=" mt-3 py-2 block text-2xl font-bold m-auto cursor-pointer hover:text-black" href="{{ Route('AggData') }}"> 2010-2020 </a>
				@else
				<a onclick="alert('Generating the charts for this view will take longer becuase of the large dataset');" class=" mt-3 py-2 block text-2xl font-bold m-auto cursor-pointer hover:text-black" href="{{ Route('AggData') }}"> 2010-2020 </a>
				@endif
			</div>
		</div>	

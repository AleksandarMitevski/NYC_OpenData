<div class="container mx-auto px-5">	
	<x-chartContainer :year=$year>
		@include('components.charts.reportsBar')
	</x-chartContainer>
		<div class="container mt-20 ml-8 mx-auto">
			<div class="flex text-center xl:flex lg:flex md:block sm:block">
				...
				<div class="flex-1">
					...
					<a href="{{Route('aggregateCityData')}}" class="py-2 px-4 text-gray-800 text-lg font-bold rounded m-auto cursor-pointer hover:text-black focus:outline-none focus:shadow-none">Pie chart for the amount of reports per city from 2010 to 2020</a>
					</div>
				</div>
				<div class="flex-1">
					<div style="width: 450px;">
					<a href="{{Route('aggregateAgencyData')}}" class="py-2 px-2 text-gray-800 text-lg font-bold rounded m-auto cursor-pointer hover:text-black focus:outline-none focus:shadow-none">Pie chart for the amount of reports per agency from 2010 to 2020</a>
					</div>
				</div>
				@else

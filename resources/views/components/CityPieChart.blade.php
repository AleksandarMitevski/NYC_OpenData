		...
		<div class="container mt-20 mx-auto">
			<div class="flex text-center xl:flex lg:flex md:block sm:block">
				...
				<div class="flex-1">
					...
					<a href="{{Route('AggData')}}" class="py-2 px-4 text-gray-800 text-lg font-bold rounded m-auto cursor-pointer hover:text-black focus:outline-none focus:shadow-none"> Bar chart for the number of reports per year from 2010-2020</a>
					</div>
				</div>
				<div class="flex-1">
					<div style="width: 450px;">
					<a href="{{Route('AggAData')}}" class="py-2 px-2 text-gray-800 text-lg font-bold rounded m-auto cursor-pointer hover:text-black focus:outline-none focus:shadow-none">Pie chart for the amount of reports per agency from 2010-2020</a>
					</div>
				</div>
				@else
